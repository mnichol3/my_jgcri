...
# Absolute path of the script we want to call
# F_PATH <- file.path(BASE_DIR, "code/module-S/S1.1.write_summary_data.R", fsep = .Platform$file.sep)
F_PATH <- "code/module-S/S1.1.write_summary_data.R"

# Path to the CEDS intermediate output directory
# INTER_DIR <- file.path(BASE_DIR, "intermediate-output", fsep = .Platform$file.sep)
INTER_DIR <- "intermediate-output"

# source('C:/Users/nich980/code/CEDS/code/module-S/S1.1.write_summary_data.R')
