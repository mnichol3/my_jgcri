...
## Activating the CEDS renv envorinment
Following a fresh installation of CEDS, R packages needed to run CEDS can be easily installed by activating the renv environment. However, there are some prerequisites to take care of first. 
